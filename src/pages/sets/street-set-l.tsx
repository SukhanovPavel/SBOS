...
export default function StreetSetL() {
        ...
        <>
            ...
            <main className={styles.main}>
                <div className={styles._}>
                    <h1>HD-CVI КОМПЛЕКТ ВИДЕОНАБЛЮДЕНИЯ L ДЛЯ УЛИЦЫ</h1>
                    <div className={styles.blocks}>
                        <div className={styles.block}>
                            <img
                                className={styles.img}
                                src="https://videonablydenie.ru/assets/img/komplekti/DS-H104G3.jpg"
                                alt="HD-CVI КОМПЛЕКТ ВИДЕОНАБЛЮДЕНИЯ L ДЛЯ УЛИЦЫ"
                            />
                        </div>
                        <div className={styles.block}>
                            <h3>Цена с установкой 30500 руб.</h3>
                            <div>Кол-во камер: 3</div>
                ...
                <div className={styles.complect}>
                    ...
                    <p><span>{DONE}</span>  Цветная камера высокого разрешения 720P (1280×720) - 3шт.</p>
                    <p><span>{DONE}</span>  Цифровой видеорегистратор с возможностью просмотра через интернет - 1шт.</p>
                    <p><span>{DONE}</span>  Жесткий диск для записи видеоархива на 1 месяц - 1шт.</p>
                    <p><span>{DONE}</span>  Стабилизированный блок питания на 12В - 1шт.</p>
                    <p><span>{DONE}</span>  Комбинированные кабели для видео систем.</p>
                    <p><span>{DONE}</span>  Монтажный комплект (разъемы RJ-45, термоусадка, саморезы, дюбеля ...).</p>
                    <p><span>{DONE}</span>  Монтажные работы.</p>
                </div>
            </main>
