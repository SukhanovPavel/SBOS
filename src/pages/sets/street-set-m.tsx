...
export default function StreetSetM() {
        ...
        <Layout meta="Видеонаблюдение WI-FI комплект видеонаблюдения. Видеонаблюдение, системы безопасности, камеры, оборудование. Установка систем видеонаблюдения в Шатуре">
            <main className={styles.main}>
                <div className={styles._}>
                    <h1>HD-CVI КОМПЛЕКТ ВИДЕОНАБЛЮДЕНИЯ M ДЛЯ УЛИЦЫ</h1>
                    <div className={styles.blocks}>
                        <div className={styles.block}>
                            <img
                                className={styles.img}
                                src="https://videonablydenie.ru/assets/img/komplekti/DS-H104G2.jpg"
                                alt="HD-CVI КОМПЛЕКТ ВИДЕОНАБЛЮДЕНИЯ M ДЛЯ УЛИЦЫ"
                            />
                        </div>
                        <div className={styles.block}>
                            <h3>Цена с установкой 23690 руб.</h3>
                ...
                <div className={styles.complect}>
                    ...
                    <p>{DONE}  Цветная камера высокого разрешения 720P (1280×720) - 2шт.</p>
