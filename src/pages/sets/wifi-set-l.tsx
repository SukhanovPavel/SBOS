...
export default function WifiSetL() {
        ...
        <>
            ...
            <main className={styles.main}>
                    ...
                    <div className={styles.blocks}>
                        <div className={styles.block}>
                            <img
                                ...
                                src="https://videonablydenie.ru/assets/img/komplekti/DH-IPC3-min.jpg"
                                alt="WI-FI КОМПЛЕКТ ВИДЕОНАБЛЮДЕНИЯ L"
                            />
                        </div>
                        <div className={styles.block}>
                            <h3>Цена с установкой 41790 руб.</h3>
                ...
                <div className={styles.complect}>
                    ...
                    <p>{DONE}  IP камера высокого разрешения 2Mp - 3шт. (камера с микрофоном)</p>
