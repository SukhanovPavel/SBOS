...
export default function WifiSetM() {
        ...
        <Layout meta="Видеонаблюдение WI-FI комплект видеонаблюдения. Видеонаблюдение, системы безопасности, камеры, оборудование. Установка систем видеонаблюдения в Шатуре">
            <main className={styles.main}>
                    ...
                    <div className={styles.blocks}>
                        <div className={styles.block}>
                            <img
                                ...
                                src="https://videonablydenie.ru/assets/img/komplekti/DH-IPC2-min.jpg"
                                alt="WI-FI КОМПЛЕКТ ВИДЕОНАБЛЮДЕНИЯ M"
                            />
                        </div>
                        <div className={styles.block}>
                            <h3>Цена с установкой 28090 руб.</h3>
                ...
                <div className={styles.complect}>
                    ...
                    <p>{DONE}  IP камера высокого разрешения 2Mp - 2шт. (камера с микрофоном)</p>
