...
export default function WifiSetS() {
        ...
        <>
            ...
            <main className={styles.main}>
                <div className={styles._}>
                    <h1>WI-FI КОМПЛЕКТ ВИДЕОНАБЛЮДЕНИЯ S</h1>
                    <div className={styles.blocks}>
                        <div className={styles.block}>
                            <img
                                className={styles.img}
                                src="https://videonablydenie.ru/assets/img/komplekti/DH-IPC1-min.jpg"
                                alt="WI-FI КОМПЛЕКТ ВИДЕОНАБЛЮДЕНИЯ S"
                            />
                        </div>
                        <div className={styles.block}>
                            <h3>Цена с установкой 14490 руб.</h3>
                            ...
                            <h3>Преимущества:</h3>
                            <p>{DONE}  Быстрый монтаж (в течение 30-60 мин.)</p>
                            <p>{DONE}  Не требует прокладки проводов</p>
                            <p>{DONE}  Без абонентской платы</p>
                            <h3>Недостатки:</h3>
                            <p>Небольшой архив видеозаписей 3-7 дней</p>
                            <p>Требуется качественный Wi-fi сигнал</p>
                        </div>
                    </div>
                </div>
                <div className={styles.complect}>
                    <h3>Состав комплекта:</h3>
                    <p>{DONE}  IP камера высокого разрешения 2Mp - 1шт. (камера с микрофоном)</p>
                    <p>{DONE}  Стабилизированный блок питания на 12В - 1шт.</p>
                    <p>{DONE}  Кабель UTP категории 5e.</p>
